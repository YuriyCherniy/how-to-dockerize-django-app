...
> Старые ssh ключи на локальной машине, при необходимости, можно удалить командой: ```rm -rf ~/.ssh```
* cкопировать публичный ключ на сервер: ```ssh-copy-id root@<server_ip>```
